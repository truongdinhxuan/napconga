...
const HeaderHome = () => {
    return <div className="header-home flex items-center justify-between mx-50 *:my-3">
        {/* Logo Views */}
        <div className="logo">
            <Link to="/">
        ...
        <div className="slogan grid text-center ml-5">
            <span className="heading-title text-2xl text-red-500 font-bold" style={{ fontFamily: "Times New Roman" }}>
                An Nhiên - Vina Company Co.LTD
            </span>
            <span className="sub-title font-bold text-yellow-500 italic" style={{ fontFamily: "Times New Roman" }}>
        ...
        <div className="search-bar ml-5">
            <form className="max-w-md mx-auto">
                ...
                <div className="relative">
                    <input type="search" id="default-search" className="shadow-xl block w-70 p-4 ps-10 text-sm text-gray-900 border border-gray-300 rounded-full focus:ring-blue-500 focus:border-blue-500" placeholder="Tìm kiếm sản phẩm..." required />
        ...
        {/* Contacts */}
        <div className="contact grid ml-5 bg-[#FFF5F5] *:text-black p-2 rounded-xl shadow-xl outline-1 outline-gray-300">
            <div className="flex">
